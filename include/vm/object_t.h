 ...
 */
  static inline int
  object_get_int(object_t * v, int32_t * o)
  {
#if DEBUG
    if(!object_is_integer(v)) { return EM_RESULT_TYPE_MISMATCH; }
#endif
    size_t ret = (size_t)v;
    *o         = ((int)ret >> 2);
    return EM_RESULT_OK;
 ...
 */
  ...
  object_new_int(object_t ** out, int v)
  {
