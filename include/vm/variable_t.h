 ...
 * \return The status code
 */
em_result variable_table_new(struct machine_t * m, variable_table_t * out, variable_table_t * parent);
 ...
 */
em_result
variable_table_assign(struct machine_t * m, variable_table_t * self, string_t * name, struct object_t * value);
 ...
 */
bool
variable_table_lookup(variable_table_t * self, struct object_t ** out, string_t * name);
