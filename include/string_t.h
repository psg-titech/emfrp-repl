 ...
 */
  ...
  string_getAt(string_t * str, const int i)
  {
    return str->buffer[i];
  }
 ...
 */
  static inline void
  string_new1(string_t * out, char_t * buffer)
  {
    string_new(out, buffer, em_strlen(buffer));
  }
 ...
 */
  static inline bool
  string_compare(const string_t * v1, const string_t * v2)
  {
