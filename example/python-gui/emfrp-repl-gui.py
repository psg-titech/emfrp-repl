...
if os.name == 'nt' or os.name == 'ce':
    pathTry = [
        os.path.join(os.path.dirname(__file__), '..', 'windows', 'out', 'build', 'x64-Debug', 'libemfrp-repl.dll'),
        os.path.join(os.path.dirname(__file__), '..', 'windows', 'build', 'Debug', 'libemfrp-repl.dll'),
        os.path.join(os.path.dirname(__file__), '..', 'windows', 'out', 'build', 'x64-Release', 'libemfrp-repl.dll'),
        os.path.join(os.path.dirname(__file__), '..', 'windows', 'build', 'Release', 'libemfrp-repl.dll')
    ]
elif os.name == 'posix':
    pathTry = [
        os.path.join(os.path.dirname(__file__), '..', 'unix', 'build', 'libemfrp-repl.so'),
        os.path.join(os.path.dirname(__file__), '..', 'unix', 'build', 'libemfrp-repl.dylib')
    ]
